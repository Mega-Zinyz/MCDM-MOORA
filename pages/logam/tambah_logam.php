...
<form class="form-horizontal style-form" method="POST" action="pages/logam/aksi_tambah.php">
  <!-- Tab panes -->
  <div class="tab-content" style="background-color: white;padding: 20px;">
    ...
    <div id="menu1" class=" tab-pane fade">
      ...
      <div class="form-group">
          ...
          <div class="col-sm-10">
            <input type="number" class="form-control round-form" name="Kepadatan">
          </div>
        </div>
        <div class="form-group">
          <label class="col-sm-2 col-sm-2 control-label">Harga/Kg </label>
          <div class="col-sm-10">
            <input type="number" class="form-control round-form" name="Harga">
          </div>
        </div>
        <div class="form-group">
          <label class="col-sm-2 col-sm-2 control-label">Berat/Kg </label>
          <div class="col-sm-10">
            <input type="number" class="form-control round-form" name="Berat">
          </div>
        </div>
        <div class="form-group">
          <label class="col-sm-2 col-sm-2 control-label">Titik Lebur °C </label>
          <div class="col-sm-10">
            <input type="number" class="form-control round-form" name="Titik_Lebur">
          </div>
        </div>
        <div class="form-group">
          <label class="col-sm-2 col-sm-2 control-label">Jumlah </label>
          <div class="col-sm-10">
            <input type="number" class="form-control round-form" name="Jumlah">
          </div>
        </div>
        <div class="form-group">
